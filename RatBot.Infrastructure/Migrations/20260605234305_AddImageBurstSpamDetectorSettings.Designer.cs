...
namespace RatBot.Infrastructure.Migrations
{
    ...
    [Migration("20260605234305_AddImageBurstSpamDetectorSettings")]
    partial class AddImageBurstSpamDetectorSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RatBot.Domain.Adventure.AdventureLeaderboardMessageState", b =>
                {
                    ...
                    b.ToTable("AdventureLeaderboardMessageState", null, t =>
                        {
                            t.HasCheckConstraint("CK_AdventureLeaderboardMessageState_SingletonId", "\"Id\" = 1");
                        });
                });
